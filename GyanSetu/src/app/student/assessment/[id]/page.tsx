...
import AssessmentTakingInteractive from '../components/AssessmentTakingInteractive';
import { useParams } from 'next/navigation';

export default function StudentAssessmentTakingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32">
        <AssessmentTakingInteractive assessmentId={assessmentId} />
      </main>
    </div>
  );
}