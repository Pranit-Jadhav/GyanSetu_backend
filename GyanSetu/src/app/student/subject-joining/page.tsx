...
import SubjectJoiningInteractive from './components/SubjectJoiningInteractive';

export default function StudentSubjectJoiningPage() {
  const { user, isAuthenticated, isLoading } = useAuth();
  const hasAccess = user && (user.role === 'student' || user.role === 'teacher' || user.role === 'admin');
