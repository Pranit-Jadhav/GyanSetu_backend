...
import ClassroomManagementInteractive from './components/ClassroomManagementInteractive';

export default function TeacherClassroomManagementPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-32">
        <ClassroomManagementInteractive />
      </main>
    </div>
  );
}