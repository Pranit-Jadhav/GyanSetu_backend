...
import ClassPerformanceInteractive from './components/ClassPerformanceInteractive';

export default function ClassPerformanceAnalyticsPage() {
        ...
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-8">
            ...
            <p className="text-base text-muted-foreground">
              Comprehensive comparative analysis and institutional insights for data-driven educational decision-making
            </p>
          </div>

          <ClassPerformanceInteractive />
        </div>
      </main>
    </div>
  );
